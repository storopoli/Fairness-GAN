...
"""
    The COMPAS dataset can be obtained from: https://raw.githubusercontent.com/propublica/compas-analysis/master/compas-scores-two-years.csv
...
def load_compas_data():
	...
	path = os.path.join('./data',COMPAS_INPUT_FILE)
	df = pd.read_csv(path)
